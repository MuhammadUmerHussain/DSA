...
class Admin //Syed Shaheer Ali
{
	...
	void printDetail() //Syed Shaheer Ali 20k-1657
	{
		string fname;
		string lname;
		string mname;
		...
		ifstream EditBan("RealEstate.txt", ios::in);
			...
			while(EditBan >> nic >> fname >> mname >> lname >> phoneNumber >>  current_adress >> Password >> ban)
			{
	...
	void BanUser() //Syed Shaheer Ali 20k-1657 And Owais
	{
		string fname;
		string lname;
		string mname;
		...
		cin >> tempnic;
			...
			while(EditBan >> nic >> fname >> mname >> lname >> phoneNumber >>  current_adress >> Password >> ban)
			{
				if(nic==tempnic)
				{
					...
					Edittemp << nic << "\t" << fname <<"\t"<< mname <<"\t" << lname << "\t" << phoneNumber << "\t" <<  current_adress << "\t"<< Password <<"\t"<< ban << "\n";
				//EditBan.close()		
				}
				else
				{
				Edittemp << nic << "\t" << fname <<"\t"<< mname <<"\t" << lname << "\t" << phoneNumber << "\t" <<  current_adress << "\t"<< Password <<"\t"<< ban << endl;
				}
			}
			...
			Edittemp.close();
		     ...
		     while(edittemp >> nic >> fname >> mname >> lname >> phoneNumber >>  current_adress >> Password >> ban)
		     {
		     	editB << nic << "\t" << fname <<"\t"<< mname <<"\t" << lname << "\t" << phoneNumber << "\t" <<  current_adress << "\t"<< Password <<"\t"<< ban << endl;
...
class user //Syed Shaheer Ali
{
	...
	public:
		...
		while(login >> nic >> fname >> mname >> lname >> phoneNumber >>  current_adress >> Password)
		{
...
set_NIC(inputstring()); //a.input_NIC();
outfile << get_nic() << "\t"; //will store data and leave 
printf("..................................................................\n");

printf("Enter your First Name:");
set_fname(inputstring());
outfile << get_fname() << "\t";
printf("..................................................................\n");

printf("Enter your Middle Name:");
set_mname(inputstring());
outfile << get_mname() << "\t";
printf("..................................................................\n");

printf("Enter your Last name:");
set_lname(inputstring());
outfile << get_lname() << "\t";
printf("..................................................................\n");

printf("Enter your phone number:");
set_PhoneNumber(inputstring());
outfile << get_phone_Number() << "\t";
printf("..................................................................\n");

printf("Enter your current adress use \"_\"(undescore) instead of space:");
set_currentAress(inputstring());
outfile << get_current_Adress() << "\t";
printf("..................................................................\n");

ban = 1;
printf("Enter your Password: ");
set_password(inputstring());
outfile << get_password() << "\t" << ban <<"\t\n";
...
// must have a has a relation but for now we will deal with is a relation.
class property // Umer
{
	protected:
		string city;
...
class Appartment: public property // Umer
{
	int FloorNum;
	int RoomNo;
//	int number_of_room;
...
class Land : public property //Owais
{
	float size;
...
class House : public property //Owais
{	
...
//FROM HERE ALL ME SYED SHAHEER ALI NO HELP FORM GROUP MATES


class seller: public user //Syed sHAHEER Ali
{
	private:
...
void login() //syed shaheer ali 20k-1657 
{
	string password;
	string Cnic;
	loader("Loading Please Wait!");
	...
	while(option==1)
	{
		...
		{
			//cout << "Check: ";
		while(login >> nic >> fname >> mname >> lname >> phoneNumber >>  current_adress >> Password >> ban)
		{
			//cout << "Check: ";
	//	cout << Password;
	//	cout << nic;
